...
// Extracted exact column styles from the design
const COLUMNS = [
	{ id: 'todo', title: 'Todo', count: 24, bg: 'bg-[#F8FAFC]', headerText: 'text-slate-700' },
	{ id: 'inProgress', title: 'In Progress', count: 5, bg: 'bg-[#EEF2FF]', headerText: 'text-indigo-700' },
	{ id: 'review', title: 'Review Required', count: 3, bg: 'bg-[#FFFBEB]', headerText: 'text-amber-700' },
	{ id: 'done', title: 'Done', count: 8, bg: 'bg-[#ECFDF5]', headerText: 'text-emerald-700' },
];
...
// SMART CLIENT COMPONENT: Handles Drag & Drop state
export function KanbanBoard({ initialTasks }: KanbanBoardProps) {
	...
	const onDragEnd = (result: DropResult) => {
		...
		// In production: Dispatch Redux thunk here to update backend
	};
